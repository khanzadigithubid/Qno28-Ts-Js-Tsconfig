"use strict";
/* 28. Stages of Life: Write an if-else chain that determines a
person’s stage of life. Set a value for the variable age, and
then:
...
let age = 28;
//Determines a person’s stage of life using if else chain
if (age < 2) {
